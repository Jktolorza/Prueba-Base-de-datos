...
ALTER TABLE relation_8 ADD CONSTRAINT relation_8_pk PRIMARY KEY ( alternativa_idalternativa,
...
ALTER TABLE relation_8
    ADD CONSTRAINT relation_8_respuesta_fk FOREIGN KEY ( respuesta_idrespuesta )
